    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-sm-12 important-text">
                <p>Компания ООО «Колорэкспресс» - нестандартный подход к наружной рекламе.</p>
                <p>Компания оказывает услуги по размещению рекламы международных и отечественных брендов на собственных рекламоносителях.</p>
                <p>Уникальный опыт, полученный нами за 20 лет, позволяет реализовывать идеи любой сложности, обеспечив при этом Заказчика профессионализмом, качеством и гарантией.</p>
                <p>Почему стоит выбрать нас?</p>
                <p class="bold">Потому что нестандартно!</p>
            </div>
        </div>
        <hr/>
