                ...
                <div class="content">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <span class="pull-right" onclick="$('#signin').modal('hide');$('#forgot_pass').modal('show');" style="text-align:right;"><u>Забыли пароль?</u></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<?= \app\components\ForgotPassWidget::widget(); ?>